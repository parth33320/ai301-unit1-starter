...
- Repo: `https://github.com/codepath/pathreview-ai301-fa26-s3/issues`
...
I am a software engineering student with experience in Python, TypeScript, AI agents, and web applications.
I am interested in working on backend tools, documentation improvements, unit tests, and well-bounded bug fixes.
I want to avoid vague architectural overhauls, mega-issues without specs, or repos with explicit AI contribution bans.
